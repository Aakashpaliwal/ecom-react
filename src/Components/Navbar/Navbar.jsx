  ...
  render() {
    ...
    <div className="collapse navbar-collapse custom-below-navbar" id="navbar-collapse">
        <ul className="nav navbar-nav ml-auto">
            ...
            <li className="nav-item"> <a className="nav-link" href="#about">Shop</a>
            </li>
            <li className="nav-item"> <a className="nav-link" href="#portfolio">Blog</a>
            </li>
           <Link to ="/Projects"> <li className="nav-item"> <a className="nav-link" href="#portfolio">Pages</a>
            </li></Link>
            ...
            <li className="nav-item"> <a className="nav-link" href="#contact">Portfolio</a>
            </li>
